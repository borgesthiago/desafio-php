 ...
 */
final class Version20181210135225 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE funcionario (id INT AUTO_INCREMENT NOT NULL, secretaria_id INT NOT NULL, remuneracao_id INT DEFAULT NULL, contato_id INT DEFAULT NULL, nome VARCHAR(255) NOT NULL, matricula VARCHAR(7) NOT NULL, cpf VARCHAR(11) NOT NULL, endereco VARCHAR(255) DEFAULT NULL, status INT NOT NULL, tipo VARCHAR(50) NOT NULL, admissao DATE DEFAULT NULL, exoneracao DATE DEFAULT NULL, INDEX IDX_7510A3CF584CC12E (secretaria_id), UNIQUE INDEX UNIQ_7510A3CF3AF70DDF (remuneracao_id), INDEX IDX_7510A3CFB279BE46 (contato_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
